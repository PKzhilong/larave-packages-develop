...
namespace LeWaiJiao\Src { 
    ...
    class PaymentsFacade {
         ...
         * @static 
         */ 
        public static function payInstance($payment)
        {
            return \LeWaiJiao\Src\Payments::payInstance($payment);
        }
        ...
        {
            return \LeWaiJiao\Src\Payments::getConfig();
        }
        ...
        {
            return \LeWaiJiao\Src\Payments::orderCheck();
        }
        ...
        {
            return \LeWaiJiao\Src\Payments::pay();
        }
        ...
        {
            return \LeWaiJiao\Src\Payments::refund();
        }
         ...
         * @static 
         */ 
        public static function outTradeNoGenerate()
        {
            return \LeWaiJiao\Src\Payments::outTradeNoGenerate();
        }
        ...
        {
            return \LeWaiJiao\Src\Payments::withdraw();
        }
...
namespace  { 
    ...
    class Payment extends \LeWaiJiao\Src\PaymentsFacade {}
